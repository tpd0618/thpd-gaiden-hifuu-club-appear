...
public class BossMarisaSprite extends MobSprite {
	...
	public BossMarisaSprite() {
		super();

		texture( Assets.Sprites.BOSSMARISA );
	...
	public void link(Char ch) {
		...
		if (((BossMarisa)ch).beamCharged) play(charging);
	}
