...
import com.touhoupixel.touhoupixeldungeongaiden.scenes.WelcomeScene;
...
public class ShatteredPixelDungeon extends Game {
	...
	public ShatteredPixelDungeon( PlatformSupport platform ) {
		...
		com.watabou.utils.Bundle.addAlias(
				com.touhoupixel.touhoupixeldungeongaiden.actors.buffs.Bleeding.class,
				"com.shatteredpixel.shatteredpixeldungeon.levels.features.Chasm$FallBleed" );

		com.watabou.utils.Bundle.addAlias(
				com.touhoupixel.touhoupixeldungeongaiden.items.weapon.curses.Dazzling.class,
				"com.shatteredpixel.shatteredpixeldungeon.items.weapon.curses.Exhausting" );
		com.watabou.utils.Bundle.addAlias(
				com.touhoupixel.touhoupixeldungeongaiden.items.weapon.curses.Explosive.class,
		...
		com.watabou.utils.Bundle.addAlias(
				com.touhoupixel.touhoupixeldungeongaiden.levels.rooms.special.CrystalVaultRoom.class,
		...
		//pre-v1.0.0
		com.watabou.utils.Bundle.addAlias(
				com.touhoupixel.touhoupixeldungeongaiden.items.stones.StoneOfFear.class,
				"com.shatteredpixel.shatteredpixeldungeon.items.stones.StoneOfAffection" );
		com.watabou.utils.Bundle.addAlias(
				com.touhoupixel.touhoupixeldungeongaiden.items.stones.StoneOfDeepSleep.class,
