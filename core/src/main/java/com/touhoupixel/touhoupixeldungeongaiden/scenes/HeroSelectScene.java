...
import com.touhoupixel.touhoupixeldungeongaiden.ui.ExitButton;
...
import com.touhoupixel.touhoupixeldungeongaiden.windows.WndTextInput;
import com.touhoupixel.touhoupixeldungeongaiden.utils.DungeonSeed;
import com.touhoupixel.touhoupixeldungeongaiden.windows.WndChallenges;
import com.touhoupixel.touhoupixeldungeongaiden.windows.WndHeroInfo;
...
public class HeroSelectScene extends PixelScene {
	...
	public void create() {
		...
		background = new Image(HeroClass.PLAYERRENKO.splashArt()) {
			@Override
			public void update() {
				if (rm > 1f) {
					rm -= Game.elapsed;
