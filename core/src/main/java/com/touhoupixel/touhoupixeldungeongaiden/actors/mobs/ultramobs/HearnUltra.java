...
import com.touhoupixel.touhoupixeldungeongaiden.actors.mobs.Hearn;
...
public class HearnUltra extends Hearn {
    ...
    protected boolean act() {
        if (this.state != SLEEPING && this.state != FLEEING && Random.Int(5) == 0) {
            switch (Random.Int(4)) {
                case 0:
                default:
