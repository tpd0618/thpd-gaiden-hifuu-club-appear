...
import com.touhoupixel.touhoupixeldungeongaiden.actors.mobs.Minoriko;
...
public class MinorikoUltra extends Minoriko {
    ...
    protected boolean steal(Hero heroine) {
        ...
        if (toSteal != null && !toSteal.unique && toSteal.level() < 1) {
            ...
            GLog.w(Messages.get(MinorikoUltra.class, "stole", toSteal.name()));
