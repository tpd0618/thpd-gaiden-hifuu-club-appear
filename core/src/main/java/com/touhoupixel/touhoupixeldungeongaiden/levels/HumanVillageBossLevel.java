...
public class HumanVillageBossLevel extends Level {
	...
	public void playLevelMusic() {
		Music.INSTANCE.playTracks(
				new String[]{Assets.Music.BOSS_FLOOR_1, Assets.Music.BOSS_FLOOR_1, Assets.Music.BOSS_FLOOR_1},
				new float[]{1, 1, 0.5f},
				false);
	}
	...
	public String tilesTex() {
		return Assets.Environment.TILES_2;
	}

	@Override
	public String waterTex() {
		return Assets.Environment.WATER_2;
	}
	...
	public void seal() {
		...
		set( 185, Terrain.EMPTY );
		GameScene.updateMap( 185 );

		BossKosuzu boss = new BossKosuzu();
